...
// @Param        payload body dto.TwoFactorVerifyInput true "payload"
// @Success      200  {object}  response.ResponseData
// @Failure      500  {object}  response.ErrorResponseData
// @Router      /auth/two_factor/verify [post]
func (s *sUser2FA) VerifyTwoFactor(ctx *gin.Context) {
	var params dto.TwoFactorVerifyInput
